...
import MeetingsList from './MeetigsList';
            ...
            <div className="container mt-4">
                <div className="row justify-content-center">
                    ...
                    <div className="col-11 col-md-6 text-center">
                        <div className="card borer-top-0 rounded-0">
                         ...
                         {this.props.meetings && (
                             <div className="list-group  list-group-flush"> 
                                 <MeetingsList userID={this.props.userID} meetings={this.props.meetings}></MeetingsList>
                             </div>
                         )}                          
                        </div>
                    </div>
