...
class AttendeesList extends Component {
    ...
    toggleStar = (e,meetingID,attendeeID,star) =>{
        e.preventDefault();
        const adminUser = this.props.adminUser;
    ...
    render() {
        const admin = (this.props.userID === this.props.adminUser)? true : false;                             
                ...
                <div className="card">
                    ...
                    {admin && (
                        ...
                        <div className="btn-group pr-2">
                            ...
                            onClick ={e =>this.toggleStar(e,this.props.meetingID,item.attendeeID,item.star)}
                            >
                             <GoStar/>   
                            </button>
